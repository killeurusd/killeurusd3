...
export default function Banner() {
  return (
    <aside aria-label="Annonce du programme" className="fixed top-0 left-0 w-full h-10 bg-[#7A0F0F] text-white flex items-center overflow-hidden z-[60] text-xs md:text-sm font-bold tracking-widest uppercase">
      <style>{`
        @keyframes marquee {
